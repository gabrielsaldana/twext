...
<html>
	<head>
		...
		<script src='twexter/jquery.js'></script>
		<script src='twexter/twexter.js'></script>
	...
	<body style='font-family: arial; padding:0px; margin:0px;'>
		...
		<div style='width:100%; height:100%; position:absolute;'>
			...
			<form action='twexter.php' method='post'>
				<div class='tabber' style='position:absolute; top:40px; height:auto; left:10px; right:10px; bottom:10px;'>zzzzzzzzz
					<div class='tabbertab'>
						<h2>input twext</h2>
